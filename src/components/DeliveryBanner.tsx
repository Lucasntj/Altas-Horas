...
export default function DeliveryBanner() {
  return (
    <div className="rounded-2xl border border-yellow-500/26 bg-gradient-to-r from-yellow-500/10 to-yellow-300/5 px-3 py-3 sm:px-4">
      <div className="grid grid-cols-1 gap-2 text-base sm:grid-cols-3 sm:gap-3 sm:text-sm">
        <div className="flex items-center gap-2 rounded-xl border border-white/10 bg-black/30 px-3 py-2.5 text-zinc-200">
          <IconClock
            size={16}
