...
const reviews = [
  {
    id: 1,
    name: "Carlos M.",
    text: "Melhor smash burger da região! Chegou quentinho e dentro do prazo. O sabor é incrível, super recomendo!",
    rating: 5,
    time: "há 2 dias",
  },
  {
    id: 2,
    name: "Fernanda L.",
    text: "Onion rings crocantes demais e o milk shake de Ovomaltine é viciante.",
    rating: 5,
    time: "há 5 dias",
  },
  {
  ...
  },
  {
    id: 4,
    name: "Juliana O.",
    text: "Cardápio do site é muito prático, gostei dos produtos. Lanche top!",
    rating: 5,
    time: "há 1 semana",
  },
];
